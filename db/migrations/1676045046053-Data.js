module.exports = class Data1676045046053 {
    name = 'Data1676045046053'

    async up(db) {
        await db.query(`CREATE TABLE "work_report" ("id" character varying NOT NULL, "added_files" jsonb, "deleted_files" jsonb, "extrinsic_id" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "account_id" character varying, CONSTRAINT "PK_d3963847f6d836c01111b720a9a" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_009fa77c8c70a39a67a25f3f56" ON "work_report" ("account_id") `)
        await db.query(`CREATE TABLE "join_group" ("id" character varying NOT NULL, "owner" text NOT NULL, "extrinsic_id" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "member_id" character varying, CONSTRAINT "PK_2a7b1ecdc60d0cdaa81236728e3" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_f47a3dffdbfc9ae668a9896fe8" ON "join_group" ("member_id") `)
        await db.query(`CREATE TABLE "storage_order" ("id" character varying NOT NULL, "file_cid" text NOT NULL, "extrinsic_id" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "block_hash" text NOT NULL, "block_num" integer NOT NULL, "account_id" character varying, CONSTRAINT "PK_06e664dc46461836b7750a53b28" PRIMARY KEY ("id"))`)
